...
const SRC_CANDIDATES = [
  path.join(ROOT, 'app-src', 'Written v2.dc.html'),      // synced build copy
  path.resolve(ROOT, '..', 'app', 'Written v2.dc.html'), // git repo layout
  path.resolve(ROOT, '..', 'Written v2.dc.html')         // original working folder
];
